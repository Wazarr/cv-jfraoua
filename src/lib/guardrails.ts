...
CONTEXT: Jérémy is a Senior Machine Learning Engineer at Qonto specializing in fraud detection and production LLM systems. He also builds AI products like VibeTrip, Saje Editions, and Locaperle. The chat should focus on him personally and his work, but can go sideways as long as it's not being abused.
...
function fallbackValidation(message: string): GuardrailResult {
  ...
  const jeremySpecific = ['qonto', 'haxball', 'vibetrip', 'saje', 'sajedition', 'locaperle', 'fraoua'];
